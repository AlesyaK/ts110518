...
//     Первым всегда должен быть массив.
    ...
    let isInArray: ( sArr: Array<string | number>, ...rest: any[] ) => boolean =
...
//     Аргументы могут быть либо строкового либо числового типа. Количество их не ограничено
    ...
    let summator: (...rest: Array<string | number> ) => number =
        ( ...rest ) => {
            let sum: number = 0;
            rest.forEach( ( item ) => {
